...
public class WSHandEntryBarcodeDialog extends WSCommonDialog implements DialogInterface.OnDismissListener {
    ...
    public WSHandEntryBarcodeDialog(Context context, String title, WSDialogCallBackTwo dialogCallBack) {
    ...
    public WSHandEntryBarcodeDialog(Context context, int themeResId) {
        super(context, themeResId);
        initDialogView();
    }

    protected WSHandEntryBarcodeDialog(Context context, boolean cancelable, DialogInterface.OnCancelListener cancelListener) {
