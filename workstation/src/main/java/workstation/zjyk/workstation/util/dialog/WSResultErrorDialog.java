...
public class WSResultErrorDialog extends WSResultBaseDialog {
    ...
    public WSResultErrorDialog(Context context, String title) {
        this(context, -1, title, false, null);

    }

    public WSResultErrorDialog(Context context, int code, String title, boolean isTwoTips, WSErrorResultClickListner errorResultClickListner) {
    ...
    public WSResultErrorDialog(Context context, int themeResId) {
        super(context, themeResId);
        initDialogView(context);
    }

    protected WSResultErrorDialog(Context context, boolean cancelable, OnCancelListener cancelListener) {
