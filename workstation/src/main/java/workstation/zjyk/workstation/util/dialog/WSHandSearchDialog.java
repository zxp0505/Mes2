...
public class WSHandSearchDialog extends WSCommonDialog implements DialogInterface.OnDismissListener {
    ...
    public WSHandSearchDialog(Context context, String title, WSDialogCallBackTwo dialogCallBack) {
    ...
    public WSHandSearchDialog(Context context, int themeResId) {
        super(context, themeResId);
        initDialogView();
    }

    protected WSHandSearchDialog(Context context, boolean cancelable, OnCancelListener cancelListener) {
