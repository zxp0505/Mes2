...
public class WSInspectTaskListPresent extends WSRxPresent<WSInspectListView> {

    private final WSTaskRequest mTaskRequest;

    public WSInspectTaskListPresent() {
    ...
    public void requestInspectTaskList(WSTaskTypeEnum type, int pageNo, int pageSize, String searchText, String searchDate, String dateType, boolean isShowLoad) {
        Map<String, String> params = new HashMap<>();
...
//        params.put("dateType", dateType);
        mTaskRequest.requestInspectTaskList(params, getView(), new WSRxDataCallBack<List<WSOrderCheckVo>>() {
            @Override
            public void onSucess(List<WSOrderCheckVo> wsWorkStationTasks) {
                if (getView() != null) {
