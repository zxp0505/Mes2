...
public class WSAdapterTrayListMaterail extends BaseMultiItemQuickAdapter<MultiItemEntity, BaseViewHolder> {
     ...
     *
     */
    public WSAdapterTrayListMaterail() {//List<MultiItemEntity> data
        super(null);
        addItemType(TYPE_LEVEL_0, R.layout.item_expandable_materail_lv0);
        addItemType(TYPE_LEVEL_1, R.layout.item_expandable_materail_lv1);
    }
    ...
    protected void convert(BaseViewHolder holder, MultiItemEntity item) {
        switch (holder.getItemViewType()) {
            ...
            case TYPE_LEVEL_1:
                ...
                holder.setText(R.id.tv_materail_number, level1Item.number);
                break;
        }
    }
