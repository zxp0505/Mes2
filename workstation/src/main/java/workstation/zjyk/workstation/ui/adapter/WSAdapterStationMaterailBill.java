...
public class WSAdapterStationMaterailBill extends BaseQuickAdapter<WSMaterial, BaseViewHolder> {
    public WSAdapterStationMaterailBill() {
        super(R.layout.item_station_materil_bill);
    }
