...
import workstation.zjyk.workstation.ui.views.MvpView;


/**
 * CommonBaseObsever base implementation of a {@link WSMvpPresenter} that uses a <b>WeakReference</b> for referring
 ...
 * WSMvpPresenter#detachView(boolean)} will be called) then you can run into the scenario that the
 ...
 * {@link WSMvpPresenter} is an interface. Hence implementing you own Presenter is easy.
 * </p>
 *
 ...
 * @since 1.0.0
 */
public class WSMvpBasePresenter<V extends MvpView> implements WSMvpPresenter<V> {
