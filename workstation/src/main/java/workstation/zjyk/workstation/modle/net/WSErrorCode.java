...
public class WSErrorCode {
    ...
    public static final String CODE_RECIVERED = "1000";//已接收code
    public static final String CODE_PRODUCT = "1002";//扫描生产编号直接进任务详情
    public static final String CODE_RECIVER_M_TO_ENTRY_DETAIL = "1001";//接收物料进任务详情
}
