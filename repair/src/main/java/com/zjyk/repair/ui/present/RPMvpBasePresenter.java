...
import com.zjyk.repair.ui.views.MvpView;


/**
 * CommonBaseObsever base implementation of a {@link RPMvpPresenter} that uses a <b>WeakReference</b> for referring
 ...
 * RPMvpPresenter#detachView(boolean)} will be called) then you can run into the scenario that the
 ...
 * {@link RPMvpPresenter} is an interface. Hence implementing you own Presenter is easy.
 * </p>
 *
 ...
 * @since 1.0.0
 */
public class RPMvpBasePresenter<V extends MvpView> implements RPMvpPresenter<V> {
