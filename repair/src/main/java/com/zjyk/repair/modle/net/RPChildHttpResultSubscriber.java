...
public abstract class RPChildHttpResultSubscriber<T> extends RPBaseHttpResultSubscriber<T> {
    RPBaseView baseView;
    RPErrorResultClickListner errorResultClickListner;

    public RPChildHttpResultSubscriber(@NonNull RPBaseView baseView, Type type) {
        this(baseView, type, null);
    }

    public RPChildHttpResultSubscriber(@NonNull RPBaseView baseView, Type type, RPErrorResultClickListner errorResultClickListner) {
