...
public abstract class QAChildHttpResultSubscriber<T> extends QABaseHttpResultSubscriber<T> {
    QABaseView baseView;
    QAErrorResultClickListner errorResultClickListner;

    public QAChildHttpResultSubscriber(@NonNull QABaseView baseView, Type type) {
        this(baseView, type, null);
    }

    public QAChildHttpResultSubscriber(@NonNull QABaseView baseView, Type type, QAErrorResultClickListner errorResultClickListner) {
