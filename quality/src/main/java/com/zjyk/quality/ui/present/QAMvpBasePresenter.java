...
import com.zjyk.quality.ui.views.MvpView;

import java.lang.ref.WeakReference;


/**
 * CommonBaseObsever base implementation of a {@link QAMvpPresenter} that uses a <b>WeakReference</b> for referring
 ...
 * QAMvpPresenter#detachView(boolean)} will be called) then you can run into the scenario that the
 ...
 * {@link QAMvpPresenter} is an interface. Hence implementing you own Presenter is easy.
 * </p>
 *
 ...
 * @since 1.0.0
 */
public class QAMvpBasePresenter<V extends MvpView> implements QAMvpPresenter<V> {
