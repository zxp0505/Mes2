package com.zjyk.quality.ui.fragment;
...
public abstract class QABaseFragment<P extends QARxPresent> extends SupportFragment implements QABaseView, View.OnClickListener {
    ...
    public void showLoadingDialog(String message) {
        if (mActivity != null && mActivity instanceof QAMainActivity) {
            ((QAMainActivity) mActivity).showLoadingDialog(message);
        }
    }
    ...
    public void hideLoadingDialog() {
        if (mActivity != null && mActivity instanceof QAMainActivity) {
            ((QAMainActivity) mActivity).hideLoadingDialog();
        }
    }
    ...
    public void showResultError(String message) {
        if (mActivity != null && mActivity instanceof QAMainActivity) {
            ((QAMainActivity) mActivity).showResultError(message);
        }
    }
    ...
    public void showResultError(int code, String message, QAErrorResultClickListner errorResultClickListner) {
        if (mActivity != null && mActivity instanceof QAMainActivity) {
            ((QAMainActivity) mActivity).showResultError(code, message, errorResultClickListner);
        }
    }
}
