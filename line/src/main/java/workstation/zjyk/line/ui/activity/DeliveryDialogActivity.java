...
public class DeliveryDialogActivity extends BaseActivity implements DeliveryView {
    ...
    TextView tvPrint;
    private AdapterDelivery mAdapterDelevery;
    private DeliveryPresent mDeliveryPresent;
    private Wrap wrap;
    ...
    private void initVeiw() {
        ...
        if (extras != null) {
            ...
            mDeliveryPresent = new DeliveryPresent(this);
        ...
        mAdapterDelevery = new AdapterDelivery();
        recycyleview.setLayoutManager(new LinearLayoutManager(this));
        recycyleview.setAdapter(mAdapterDelevery);
        if (materiels != null) {
            mAdapterDelevery.setNewData(materiels);
        }
    }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.tv_print:
                ...
                mDeliveryPresent.printDeliveryInfo(param_print);
                break;
...
//        if (currentPrintStatus) {
        ...
        mDeliveryPresent.scanDelivery(params);
//        } else {
