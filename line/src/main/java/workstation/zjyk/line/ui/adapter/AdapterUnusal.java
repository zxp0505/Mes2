...
public class AdapterUnusal extends BaseQuickAdapter<ExceptionDetailBean, BaseViewHolder> {
    boolean isReport;

    public AdapterUnusal(boolean isReport) {
        super(R.layout.unusal_menu_list_item);
