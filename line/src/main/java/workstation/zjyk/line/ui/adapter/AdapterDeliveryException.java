...
public class AdapterDeliveryException extends BaseQuickAdapter<MaterielVo, BaseViewHolder> {
    public AdapterDeliveryException() {
        super(R.layout.item_delivery_exception);
    }
