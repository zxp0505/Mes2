...
public interface ApiService {
    ...
    @POST()
    @FormUrlEncoded
    <T> Observable<BaseResultCommon> executePost(
            @Url() String url,
    ...
    @GET()
    <T> Observable<BaseResultCommon> executeGet(
            @Url String url,
            @QueryMap Map<String, String> maps);

    @DELETE()
    <T> Observable<BaseResultCommon> executeDelete(
            @Url String url,
            @QueryMap Map<String, Object> maps);

    @PUT()
    <T> Observable<BaseResultCommon> executePut(
            @Url String url,
    ...
    @Streaming
    @GET
    Observable<BaseResultCommon> downloadFile(@Url String fileUrl);
