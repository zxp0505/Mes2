...
////            return "http://192.168.104.197:8080/agent/";
////            return "http://192.168.3.140:8080/agent/";
//        }
//    }

    public static String GET_ORDER_BOND_LIST = "api/line/order/true/distribute/materiel/list.data";//获取订单下发列表
    ...
    public static final String GET_EXCEPTION_BIND_TRAY_SCAN = "api/exception/manager/bindingTray/data.data";//绑定异常托盘扫码 api/exception/manager/data.data
    public static final String GET_EXCEPTION_BIND_TRAY = "api/exception/manager/data.data";//绑定异常托盘
    public static final String SCAN_DELIVERY_EXCEPTION = "api/exception/manager/deliver/tray/data.data";//扫描投递异常
    ...
    public static final String SCAN_DELIVERY = "api/line/deliver/tray/data.data";//扫描投递

    //:

    public static final String GET_DELIVERY_LIST = "api/line/undeliver/tray/list.data";//获取未投递托盘列表
    public static final String GET_TRAY_INFO = "api/line/wrap/info.data";//获取托盘详细信息

    public static final String SEND_HEART = "api/pad/beatTime/data.data";//发送心跳

    public static final String CHECK_BOND_HISTORY = "api/line/distribute/history/by/task/list.data";//查询下发历史记录
    public static final String CHECK_BOND_LIST = "api/line/order/distribute/materiel/detail/info.data";//查询下发历史记录
    public static final String REQUEST_ONE_BOND = "api/line/workStation/distribute/materiel/list.data";//一键投递
    public static final String REQUEST_BOND_PRINT = "api/print/tray/info.data";//发放打印
    public static final String MAKING_OUT_BIND_TRAY = "api/workStation/bind/tray/data.data";//绑定托盘

    public static final String REQUEST_ACCESSORY_LIST = "api/line/get/order/prodcut/accessory/list.data";//获取订单产品附件
    public static final String CHECK_ACCESSORY_MD5 = "api/line/validate/order/prodcut/accessory/data.data";//获取订单产品附件MD5校验
