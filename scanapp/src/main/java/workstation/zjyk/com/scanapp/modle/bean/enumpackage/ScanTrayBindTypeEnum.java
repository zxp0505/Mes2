...
public enum ScanTrayBindTypeEnum implements BaseEnum {
	...
	WORK_STATION_WIP_OR_MATERIEL("工位接收的在制品和物料"),
	REPAIR_EXCEPTION_MATERIEL("维修异常输出物料");
	

    private final String key;

    ScanTrayBindTypeEnum(String key) {
        this.key = key;
    }
