...
import workstation.zjyk.com.scanapp.ui.views.MvpView;


/**
 * CommonBaseObsever base implementation of a {@link ScanMvpPresenter} that uses a <b>WeakReference</b> for referring
 ...
 * ScanMvpPresenter#detachView(boolean)} will be called) then you can run into the scenario that the
 ...
 * {@link ScanMvpPresenter} is an interface. Hence implementing you own Presenter is easy.
 * </p>
 *
 ...
 * @since 1.0.0
 */
public class ScanMvpBasePresenter<V extends MvpView> implements ScanMvpPresenter<V> {
