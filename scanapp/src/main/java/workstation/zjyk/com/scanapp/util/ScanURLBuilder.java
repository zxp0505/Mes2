...
//    }
    ...
    public static final String REQUEST_HISTORY_LIST = "/agent/manager/quality!getHandledRecord.action";//历史记录
    public static final String REQUEST_HISTORY_DETAIL = "/agent/manager/quality!getHandledRecordDetail.action";//历史记录详情
