...
public final class Calendar implements Serializable {
    ...
    private boolean isHasTaskMark;//是否有任务标记
    ...
    public boolean isHasTaskMark() {
        return isHasTaskMark;
    }

    public void setHasTaskMark(boolean hasTaskMark) {
        isHasTaskMark = hasTaskMark;
    }
