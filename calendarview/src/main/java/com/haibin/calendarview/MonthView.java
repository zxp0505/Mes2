    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < mLineCount; i++) {
            for (int j = 0; j < 7; j++) {
                ...
                if (mMonthViewPager.dateMap != null && mMonthViewPager.dateMap.containsKey(calendar.toString())) {
                    calendar.setHasTaskMark(true);
                } else {
                    calendar.setHasTaskMark(false);
                }
...
//            if(mMonthViewPager.dateMap != null && mMonthViewPager.dateMap.containsKey(calendarDate.toString())){
//                calendarDate.setHasTaskMark(true);
//            }
