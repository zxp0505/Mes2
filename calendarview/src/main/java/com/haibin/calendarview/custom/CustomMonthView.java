...
public class CustomMonthView extends MonthView {
     ...
     * 有标签的背景色
     */
    private Paint mHasMarkPaint = new Paint();
    ...
    public CustomMonthView(Context context) {
        ...
        mHasMarkPaint.setAntiAlias(true);
        mHasMarkPaint.setStyle(Paint.Style.FILL);
        mHasMarkPaint.setColor(0xFFFFA54F);
//
    ...
    protected void onDrawText(Canvas canvas, Calendar calendar, int x, int y, boolean hasScheme, boolean isSelected) {
        ...
        if (calendar.isHasTaskMark() && !isSelected) {
            canvas.drawCircle(cx, cy, mRadius, mHasMarkPaint);
        }
...
//        }
    ...
    public String getCurrentDate() {
        return (mYear < 10 ? 0 + mYear : mYear) + "" + (mMonth < 10 ? 0 + mMonth : mMonth);
    }
}
