...
import com.haibin.calendarview.custom.CustomMonthView;
...
//                }
    ...
    public void setDateMarkMap(Map<String, String> dateMap) {
    ...
    private class MonthViewPagerAdapter extends PagerAdapter {
        ...
        public int getItemPosition(Object object) {
            if (object instanceof CustomMonthView) {
                CustomMonthView customMonthView = (CustomMonthView) object;
                customMonthView.invalidate();
