package cn.com.ethank.mylibrary.resourcelibrary.convenientbanner;
...
import cn.com.ethank.mylibrary.resourcelibrary.convenientbanner.adapter.CBPageAdapter;
import cn.com.ethank.mylibrary.resourcelibrary.convenientbanner.holder.CBViewHolderCreator;
import cn.com.ethank.mylibrary.resourcelibrary.convenientbanner.listener.CBPageChangeListener;
import cn.com.ethank.mylibrary.resourcelibrary.convenientbanner.listener.OnItemClickListener;
import cn.com.ethank.mylibrary.resourcelibrary.convenientbanner.view.CBLoopViewPager;
...
//    }
     ...
     * @param datas
     */
    public void setPageChage(List<T> datas){
    	this.mDatas = datas;
    	viewPager.getAdapter().setDataChange(datas);
    }
    ...
    /**
     * 设置是否允许手动滑动
     * @param isManualScroll
     */
    public void setManualScroll(boolean isManualScroll){
    	this.manualScroll=isManualScroll;
    	viewPager.setManualScroll(isManualScroll);
    }
