package cn.com.ethank.mylibrary.resourcelibrary.common_util.scan;
...
private static final String TAG = "ScanGunKeyEventHelper";
    ...
    private String mDeviceName = "Honeywell HH400";
...
//        }
    ...
    public boolean isScanGunEvent(KeyEvent event) {
        return !TextUtils.isEmpty(event.getDevice().getName());
    }
