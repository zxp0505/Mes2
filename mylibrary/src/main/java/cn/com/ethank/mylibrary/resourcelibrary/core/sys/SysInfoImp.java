...
import cn.com.ethank.mylibrary.resourcelibrary.core.coding.Base64Coding;
import cn.com.ethank.mylibrary.resourcelibrary.core.coding.MD5;
import cn.com.ethank.mylibrary.resourcelibrary.core.setting.ISettingService;
...
public class SysInfoImp extends SysInfo {
    ...
    private static String getIMEI(Context ctx) {
        try {
            ...
            String mac = getMacAddress(ctx);
            if (!TextUtils.isEmpty(mac)) {
                String imei = MD5.encode(mac.getBytes());
                return imei;
            }
        }
...
//		}
    ...
    public String getUid() {
        try {
            PackageManager pm = mContext.getPackageManager();
            ApplicationInfo ai = pm.getApplicationInfo("cn.com.ethank.PMSMaster", PackageManager.GET_ACTIVITIES);
