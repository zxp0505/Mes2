...
public class GlideRoundTransform extends BitmapTransformation {
	...
	public GlideRoundTransform(Context context, View view, String url) {
		this(context);
		this.view = view;
		this.url = url;
	}

	public GlideRoundTransform(Context context, View view, String url, int designRound) {
		this(context);
		this.view = view;
		this.url = url;
		this.radius = designRound;
	}

	public GlideRoundTransform(Context context, View view, int designRound) {
		this(context);
		this.view = view;
		// 设计图按750算的圆角
		if (context != null) {
